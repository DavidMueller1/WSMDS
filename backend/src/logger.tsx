...
export class Logger {
    ...
    private static databaseColor = '\x1b[32m'
    private static websocketColor = '\x1b[33m'
    ...
    public static database(...data: any[]) {
        this.log('DATABASE', this.databaseColor, data)
    }

    public static websocket(...data: any[]) {
        this.log('WEBSOCKET', this.websocketColor, data)
    }
